...
# ----------2nd round searched architecture (RNN)----------
rnn_r0_e50_44 = Genotype(
    recurrent=[('identity', 0), ('identity', 1), ('identity', 2), ('identity', 2), ('identity', 2), ('identity', 0),
               ('identity', 0), ('identity', 0)], concat=range(1, 9))
